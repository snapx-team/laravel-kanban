...
class BoardsController extends Controller
{
    public function createBoard(Request $request)
    {
        ...
        try {
            if ($request->filled('id')) {
                ...
                Log::createLog(Auth::user()->id, Log::TYPE_BOARD_CREATED, 'Added new board <' . $board->name . '>', null, $board->id, null, null, null, null);
            }
    ...
    public function deleteBoard($id)
    {
        try {
            ...
            Log::createLog(Auth::user()->id, Log::TYPE_BOARD_DELETED, 'Deleted board <' . $board->name . '>', null, $board->id, null, null, null, null);
        } catch (\Exception $e) {
            return response([
                'success' => 'false',
                'message' => $e->getMessage(),
