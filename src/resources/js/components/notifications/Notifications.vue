    ...
    data() {
        return {
            ...
            logTypeList: [
                ...
                {name: 'Task Card Create', code: '10'},
                {name: 'Task Card Deleted', code: '11'},
                {name: 'Task Card Completed', code: '12'},
                {name: 'Task Card Moved', code: '14'},
                {name: 'Task Card Assigned To Board', code: '15'},
                {name: 'Task Card Updated', code: '16'},
                {name: 'Task Card Assigned To Group', code: '17'},
                {name: 'Task Card Changed Position In Column', code: '18'},
                {name: 'Task Card Checklist Item Checked', code: '20'},
                {name: 'Task Card Checklist Item Unchecked', code: '21'},
                {name: 'Task Card Assigned To Employee', code: '22'},
                {name: 'Task Card Unassigned To Employee', code: '23'},
