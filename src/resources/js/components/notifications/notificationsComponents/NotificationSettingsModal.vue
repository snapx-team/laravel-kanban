                ...
                <div class="flex flex-col overflow-auto z-50 w-100 bg-white rounded-md shadow-2xl m-10"
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium leading-5 text-gray-500">
                                    <em>Alter which types of notifications you want to be notified with for each board</em>
                                </p>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="flex">
                        <div class="px-8 py-6 space-y-2 border-r">
                            <span class="block text-xs font-bold leading-4 tracking-wide uppercase text-gray-600 pb-2">Boards</span>
...
export default {
    ...
    created() {
        this.eventHub.$on("update-notification-settings", () => {
            this.modalOpen = true;
            this.getAllEmployeeBoardNotificationSettings();
        });
    },
    ...
    methods: {
        ...
        getAllEmployeeBoardNotificationSettings() {
            this.asyncGetAllEmployeeBoardNotificationSettings().then((data) => {
