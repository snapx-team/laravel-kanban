<template>
    <div class="badgesList">
        <h2 class="text-2xl font-semibold py-5">Badges List</h2>
                ...
                <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div class="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                        <table class="min-w-full leading-normal">
                            ...
                            <tbody>
                            <template v-for="(badge, badgeIndex) in filtered">
                                <template v-if="badgeIndex >= paginationIndex && badgeIndex < paginationIndex + paginationStep">
                                    <tr :key="badgeIndex">
...
export default {
    ...
    methods: {
        editBadge(badge) {
            this.eventHub.$emit("create-badge", badge);
        },
