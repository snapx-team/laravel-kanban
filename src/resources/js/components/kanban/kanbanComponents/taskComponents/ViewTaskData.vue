    ...
    <div>
        ...
        <div class="inline-flex space-x-1">
            ...
            <div
                ...
                :class="cardData.status === 'active' ?  'bg-indigo-200 text-green-800':  'bg-red-200 text-red-800'">
                <span class="w-2 h-2 rounded-full mr-1"
                      :class="cardData.status === 'active' ?  'bg-green-800' :  'bg-red-800'"
                ></span>
        ...
        <div class="flex pt-3 border-t space-x-20">
            ...
            <div class="space-y-5 whitespace-nowrap">
                ...
                <div class="relative mb-5 border-b">
                    <div class="flex mb-3 items-center justify-between">
                        ...
                        <div class="text-right">
                            <span
                                class="text-xs font-semibold inline-block text-indigo-600">{{ checklistPercentage }}%</span>
                        </div>
                    </div>
                ...
                <p class="text-gray-700 font-semibold font-sans tracking-wide text-lg"  :class="{'animate-pulse': loadingRelatedTasks}" > Related Tasks: </p>
